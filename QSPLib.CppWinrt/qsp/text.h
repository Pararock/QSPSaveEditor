...
/* External functions */
int qspAddText(QSP_CHAR **, QSP_CHAR const *, int, int, QSP_BOOL);
QSP_CHAR *qspGetNewText(QSP_CHAR *, int);
QSP_CHAR *qspGetAddText(QSP_CHAR *, QSP_CHAR const *, int, int);
...
QSP_CHAR *qspStrCopy(QSP_CHAR *, QSP_CHAR const *);
QSP_CHAR *qspStrChar(QSP_CHAR *, QSP_CHAR);
QSP_CHAR *qspStrNCopy(QSP_CHAR *, QSP_CHAR const *, int);
int qspStrLen(QSP_CHAR const *);
