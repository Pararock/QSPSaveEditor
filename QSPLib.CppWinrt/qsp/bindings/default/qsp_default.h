...
extern "C"
{
    ...
    QSP_EXTERN const QSP_CHAR *QSPGetVersion(); // done
    QSP_EXTERN const QSP_CHAR *QSPGetCompiledDateTime(); // done
    QSP_EXTERN int QSPGetFullRefreshCount();
    QSP_EXTERN const QSP_CHAR *QSPGetQstFullPath(); // done
    QSP_EXTERN const QSP_CHAR *QSPGetCurLoc(); //done
    ...
    QSP_EXTERN QSP_BOOL QSPGetVarIndexesCount(const QSP_CHAR *name, int *count);
    QSP_EXTERN QSP_BOOL QSPGetVarValues(const QSP_CHAR *name, int ind, int *numVal, QSP_CHAR **strVal);
    QSP_EXTERN QSP_BOOL QSPGetVarIndex(const QSP_CHAR *name, int ind, int *numVal, QSP_CHAR **strVal);
    ...
    QSP_EXTERN void QSPGetLastErrorData(int *errorNum, QSP_CHAR **errorLoc, int *errorActIndex, int *errorLine); // should be done
    QSP_EXTERN const QSP_CHAR *QSPGetErrorDesc(int errorNum); // should be done

    QSP_EXTERN QSP_BOOL QSPLoadGameWorld(const QSP_CHAR *file); // done
    QSP_EXTERN QSP_BOOL QSPLoadGameWorldFromData(const void *data, int dataSize, const QSP_CHAR *file); //done
    ...
    QSP_EXTERN QSP_BOOL QSPOpenSavedGame(const QSP_CHAR *file, QSP_BOOL isRefresh); //done
    QSP_EXTERN QSP_BOOL QSPOpenSavedGameFromData(const void *data, int dataSize, QSP_BOOL isRefresh); //done
    ...
    QSP_EXTERN int QSPPGetLocationsCount(); //done
    QSP_EXTERN QSP_BOOL QSPGetLocationName(int index, QSP_CHAR **locName); //done
