...
void qspOpenQuestFromData(char *data, int dataSize, QSP_CHAR const *fileName, QSP_BOOL isAddLocs)
{
...
void qspOpenGameStatusFromString(QSP_CHAR const *inputstr)
{
    int i, j, ind, count, varInd, varsCount, valsCount;
    QSP_CHAR **strs, *file, *locName,*str;
    count = qspSplitStr(inputstr, QSP_STRSDELIM, &strs);
